...
def ChangeSettings(write=False):
    ...
    try:
        with open('C:\\Users\\ponna\\PycharmProjects\\VA.py\\userData/settings.pck', 'rb') as file:
...
if os.path.exists('C:\\Users\\ponna\\PycharmProjects\\VA.py\\userData/settings.pck') == False:
    ChangeSettings(True)
...
def showSingleImage(type, data=None):
    ...
    try:
        ...
        pass
    img1 = ImageTk.PhotoImage(Image.open('C:\\Users\\ponna\\Downloads\\extrafiles\\images/heads.jpg').resize((220, 200), Image.ANTIALIAS))
    img2 = ImageTk.PhotoImage(Image.open('C:\\Users\\ponna\\Downloads\\extrafiles\\images/tails.jpg').resize((220, 200), Image.ANTIALIAS))
    img4 = ImageTk.PhotoImage(Image.open('C:\\Users\\ponna\\Downloads\\extrafiles\\images/WeatherImage.png'))
    ...
    if type == "weather":
        ...
        img3 = ImageTk.PhotoImage(
            Image.open('C:\\Users\\ponna\\Downloads\\extrafiles\\images/dice/' + type + '.jpg').resize((200, 200), Image.ANTIALIAS))
...
def WAEMPOPUP(Service='None', rec='Reciever'):
    ...
    if Service == "WhatsApp":
        PopUProot.iconbitmap("C:\\Users\\ponna\\Downloads\\extrafiles\\images/whatsapp.ico")
    else:
        PopUProot.iconbitmap("C:\\Users\\ponna\\Downloads\\extrafiles\\images/email.ico")
...
if __name__ == '__main__':
    ...
    cblLightImg = PhotoImage(file='C:\\Users\\ponna\\Downloads\\extrafiles\\images/centralButton.png')
    cblDarkImg = PhotoImage(file='C:\\Users\\ponna\\Downloads\\extrafiles\\images/centralButton1.png')
    if KCS_IMG == 1:
        cblimage = cblDarkImg
    else:
    ...
    # Settings Button
    sphLight = PhotoImage(file="C:\\Users\\ponna\\Downloads\\extrafiles\\images/setting.png")
    sphLight = sphLight.subsample(2, 2)
    sphDark = PhotoImage(file="C:\\Users\\ponna\\Downloads\\extrafiles\\images/setting1.png")
    ...
    # Keyboard Button
    kbphLight = PhotoImage(file="C:\\Users\\ponna\\Downloads\\extrafiles\\images/keyboard.png")
    kbphLight = kbphLight.subsample(2, 2)
    kbphDark = PhotoImage(file="C:\\Users\\ponna\\Downloads\\extrafiles\\images/keyboard1.png")
    ...
    # Mic
    micImg = PhotoImage(file="C:\\Users\\ponna\\Downloads\\extrafiles\\images/mic.png")
    ...
    # Text Field
    TextFieldImg = PhotoImage(file='C:\\Users\\ponna\\Downloads\\extrafiles\\images/textField.png')
    ...
    # User and Bot Icon
    userIcon = PhotoImage(file="C:\\Users\\ponna\\Downloads\\extrafiles\\images\\avatars\\ChatIcons\\a11.png")
    botIcon = PhotoImage(file="C:\\Users\\ponna\\Downloads\\extrafiles\\images/assistant.png")
    ...
    # User Photo
    userProfileImg = Image.open("C:\\Users\\ponna\\Downloads\\extrafiles\\images\\avatars\\ChatIcons\\a10.png")
    userProfileImg = ImageTk.PhotoImage(userProfileImg.resize((120, 120)))
    # Change Photo
    chngPh = ImageTk.PhotoImage(Image.open("C:\\Users\\ponna\\Downloads\\extrafiles\\images/avatars/changephoto2.png").resize((120, 120)))
    ...
    cimg = PhotoImage(file="C:\\Users\\ponna\\Downloads\\extrafiles\\images/colorchooser.png")
    ...
    root.iconbitmap('C:\\Users\\ponna\\Downloads\\extrafiles\\images/assistant2.ico')
    raise_frame(root1)
    root.mainloop()